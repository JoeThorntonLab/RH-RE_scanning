...
```{r GPmapGlobalProperties_c, fig.height=5,fig.width=11}
##############################
...
# AncSR1
plot(make_ego_graph(net_sr1,order=PATH_LENGTH,nodes = "EGKA")[[1]],layout=layout_with_fr,edge.curved=.1)

#AncSR2
plot(make_ego_graph(net_sr2,order=PATH_LENGTH,nodes = "EGKA")[[1]],layout=layout_with_fr,edge.curved=.1)
```
...
```{r mut_trajectory, warning=FALSE, fig.width=8,fig.height=4}
...
4. The evolution of the derived specificity can be achieved within 1 mutation step on the protein network (GGKV is SRE1-specific), whereas in both trajectories of the complex network, the evolutionof the derived specificity requires passing through intermediate GARE-binding genotypes.
