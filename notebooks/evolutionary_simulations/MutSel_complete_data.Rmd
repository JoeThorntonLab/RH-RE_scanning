...
```{r, fitness_functions, include=FALSE, fig.width=9,fig.height=4}
...
```{r variational_prop, fig.height=5,fig.width=11,warning=FALSE}
...
```{r GPmapGlobalProperties_b, fig.height=6,fig.width=11}
##############################
# STATIONARY PDFVs
# AncSR1
...
```{r mc_chains_ref_genotype_b, fig.width=8,fig.height=6.5}
...
```{r mc_chains_ref_genotype_c, fig.width=8,fig.height=4}
