Phenotype frequency distributions SRE2 corrected
================
Jaeda Patton
2023-10-16
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/pfunctionalpredictedAncSR1-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/pfunctionalpredictedAncSR2-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/classifyfunctional-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/plotfxnalRE-3.png)<!-- -->
...
```
    ...
    ##     ERE (GT)    SRE1 (AA)    SRE2 (GA)           AC           AG           AT 
...
```
    ...
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 189.5 on 13 degrees of freedom
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/nspecific-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/nspecificRE-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/nboundspecificRE-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/nboundspecificRE-2.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/nboundspecificRE-3.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/ntotalspecificREcor-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/promiscuousheatmaps-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/promiscuousheatmaps2-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/clusteredheatmap-2.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/clusteredheatmapnospecific-1.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/clusteredheatmapnospecific-2.png)<!-- -->
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/promiscuitydeterminantsRE-1.png)<!-- -->
...
```
    ...
    ## Residuals:
    ##       Min        1Q    Median        3Q       Max 
    ## -0.040873 -0.002250 -0.000894  0.002343  0.033257 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) 0.0006176  0.0012465   0.495    0.622    
    ## p12pred     0.5612930  0.0593254   9.461 8.92e-14 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 0.008906 on 64 degrees of freedom
    ## Multiple R-squared:  0.5831, Adjusted R-squared:  0.5766 
    ## F-statistic: 89.52 on 1 and 64 DF,  p-value: 8.925e-14
    ## 
    ## [1] "AncSR2"
    ## 
    ## Call:
    ...
    ## Residuals:
    ##       Min        1Q    Median        3Q       Max 
    ## -0.066215 -0.006808 -0.005159  0.006483  0.060482 
    ## 
    ## Coefficients:
    ##             Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) 0.008407   0.001647   5.103 1.29e-06 ***
    ## p12pred     0.926594   0.054630  16.961  < 2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error:
    ## 25 AncSR2        TA  7.617663e-03 0.073758013 0.7119364 0.29503205
    ## 26 AncSR2        TC -8.258933e-03 0.055165113 0.7130858 0.29503205
    ## 27 AncSR2        TG  1.444510e-03 0.736828675 0.7044362 0.82524812
    ## 28 AncSR2        TT  1.045967e-02 0.012482059 0.7191511 0.08737441
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/promiscuitydeterminantsRE-2.png)<!-- -->
...
|:--------------|:--------------|-----:|----------:|
| nonfunctional | promiscuous   | 1059 | 0.3879121 |
| nonfunctional | specific      | 1384 | 0.5069597 |
| promiscuous   | nonfunctional |    3 | 0.0010989 |
| promiscuous   | promiscuous   |   47 | 0.0172161 |
| promiscuous   | specific      |    5 | 0.0018315 |
| specific      | nonfunctional |   63 | 0.0230769 |
| specific      | promiscuous   |  115 | 0.0421245 |
| specific      | specific      |   54 | 0.0197802 |
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/bgphenotypeswitch-1.png)<!-- -->
...
| AncSR1   | AncSR2        |   n |      frac |
|:---------|:--------------|----:|----------:|
| specific | nonfunctional |  63 | 0.2715517 |
| specific | promiscuous   | 115 | 0.4956897 |
| specific | specific      |  54 | 0.2327586 |
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/bgphenotypeswitch-2.png)<!-- -->
...
| AncSR1      | AncSR2        |   n |      frac |
|:------------|:--------------|----:|----------:|
| promiscuous | nonfunctional |   3 | 0.0104530 |
| promiscuous | promiscuous   |  47 | 0.1637631 |
| promiscuous | specific      |   5 | 0.0174216 |
| specific    | nonfunctional |  63 | 0.2195122 |
| specific    | promiscuous   | 115 | 0.4006969 |
| specific    | specific      |  54 | 0.1881533 |
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/bgphenotypeswitch-3.png)<!-- -->
...
| AncSR1        | AncSR2      |    n |      frac |
|:--------------|:------------|-----:|----------:|
| nonfunctional | promiscuous | 1059 | 0.3975225 |
| nonfunctional | specific    | 1384 | 0.5195195 |
| promiscuous   | promiscuous |   47 | 0.0176426 |
| promiscuous   | specific    |    5 | 0.0018769 |
| specific      | promiscuous |  115 | 0.0431682 |
| specific      | specific    |   54 | 0.0202703 |
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/bgphenotypeswitch-4.png)<!-- -->
...
```
    ...
    ## # A tibble: 12 × 5
    ## # Groups:   RE [12]
    ##    RE        functional_AncSR2     n ntotal  frac
    ##    <fct>     <lgl>             <int>  <int> <dbl>
    ##  1 ERE (GT)  FALSE                49    126 0.389
    ##  2 SRE1 (AA) FALSE                 0     55 0    
    ##  3 SRE2 (GA) FALSE                18     62 0.290
    ##  4 AC        FALSE                 4     17 0.235
    ##  5 AG        FALSE                 0      2 0    
    ##  6 AT        FALSE                 0     41 0    
    ##  7 CA        FALSE                 0     20 0    
    ##  8 CG        FALSE                 6      6 1    
    ##  9 GC        FALSE                 1      1 1    
    ## 10 GG        FALSE                 1      4 0.25 
    ## 11 TA        FALSE                16     28 0.571
    ## 12 TT        FALSE                 2      5 0.4
...
![](phenotype_frequency_distributions_SRE2_corrected_files/figure-gfm/bgphenotypeswitch-5.png)<!-- -->
