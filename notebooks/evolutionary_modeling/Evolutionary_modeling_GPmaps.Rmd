...
packages <- c("tidyr", "MASS", "ggplot2", "Matrix", "stringr", "tibble", 
              ...
              "ggrepel","ggridges","fitdistrplus","extraDistr","ggalluvial")
...
```{r timescales_sr1_1, fig.width=8,fig.height=5}
...
```{r outcome_similarity_sr1, fig.width=7}
###################################
...
```{r gpmap_sr2_structure_1, fig.width=6, fig.height=3.5}
