...
packages <- c("tidyr", "ggplot2", "Matrix", "stringr", "tibble", 
              ...
              "doParallel", "ggpattern", "ggseqlogo", "ggalluvial", 
...
results_dir <- file.path("..", "results", "genotype_phenotype_distributions")
```
...
```{r classifyfunctional, fig.width = 8}
...
How many functional genotypes are there in each ancestral background? Which REs do they bind to?
