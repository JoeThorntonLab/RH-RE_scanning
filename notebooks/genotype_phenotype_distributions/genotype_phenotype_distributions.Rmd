...
packages <- c("tidyr", "ggplot2", "Matrix", "stringr", "tibble", "purrr",
              ...
              "gplots", "Biostrings", "igraph", "forcats", "dplyr", "magrittr",
              "scales")
...
results_dir <- file.path(basedir, "results", "genotype_phenotype_distributions")
...
meanF_data_fxnal <- meanF_data %>%
  select(bg:meanF_REP4, functional, active) %>%
...
```{r nspecific, purl = TRUE, fig.height = 5, fig.width = 6}
...
```{r logoplots, purl = FALSE, fig.height = 6, fig.width = 7}
