...
Let's calculate the mean correlation between all replicates for all data, as well as for only those variants that are significantly different from null.
