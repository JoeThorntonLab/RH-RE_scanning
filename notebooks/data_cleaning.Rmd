...
meanF_p <- meanF_data_corrected %>%
  ...
  list(filter(., rcbin == "<100", bg == "AncSR1"),
       filter(., rcbin == "100-500", bg == "AncSR1"),
       filter(., rcbin == "500-1000", bg == "AncSR1"),
       filter(., rcbin == ">=1000", bg == "AncSR1"), 
       filter(., rcbin == "<100", bg == "AncSR2"),
       filter(., rcbin == "100-500", bg == "AncSR2"),
       filter(., rcbin == "500-1000", bg == "AncSR2"),
       filter(., rcbin == ">=1000", bg == "AncSR2"))
...
meanF_p <- mutate(meanF_p, 
                  sig = case_when(padj <= fdr.thresh ~ "sig", 
                                  padj > fdr.thresh ~ "notsig",
                                  grepl("\\*", AA_var) ~ "stop"))
