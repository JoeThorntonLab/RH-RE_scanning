...
packages <- c("rstudioapi", "tidyr", "MASS", "ggplot2", "Matrix", "stringr",
              "MatrixModels", "tibble", "dplyr", "glmnet", "patchwork", 
              "gridExtra", "doParallel", "viridis", "Biostrings", "scales", 
              "pROC")
...
if(!dir.exists(file.path("..", "R_packages", "glmnet_4.1-6"))) {
  dir.create(file.path("..", "R_packages", "glmnet_4.1-6"))
  install.packages(file.path("..", "R_packages", "glmnet_4.1-6.tar.gz"),
                   lib=file.path("..", "R_packages", "glmnet_4.1-6"), 
...
library(glmnet, lib.loc = file.path("..", "R_packages", "glmnet_4.1-6"))

# make output directories
if(!dir.exists(file.path("..", "results", "mutation_effects_model"))) {
  dir.create(file.path("..", "results", "mutation_effects_model"))
}

results_dir <- file.path("..", "results", "mutation_effects_model")
```
...
cov_table <- data.frame(effect = c("RH", "RE", "RHxRH", "RExRE", "RHxRE",
                                   "RHxRHxRH", "RHxRHxRE", "RHxRExRE",
                                   "RHxRHxRExRE", "RHxRHxRHxRE",
                                   "RHxRHxRHxRExRE"),
...
```{r, purl = FALSE, fig.width = 6, fig.height = 6}
