...
Now predict the fluorescence for the missing genotypes and export predictions.
...
Let's correct for the prediction bias that we observed during cross-validation.

```{r biascorrection, purl = FALSE}
### AncSR1
