Phenotype frequency distributions final
================
Jaeda Patton
2023-10-16
...
![](phenotype_frequency_distributions_final_files/figure-gfm/classifyfunctional-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/classifyfunctional-4.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/plotfxnalRE-3.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/nspecific-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/nspecificRE-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/nspecificpromiscuous-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/nspecificpromiscuous-2.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/nboundspecificRE-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/nboundspecificRE-2.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/nboundspecificRE-3.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/ntotalspecificREcor-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/promiscuousheatmaps-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/promiscuousheatmaps2-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/clusteredheatmap-2.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/clusteredheatmapnospecific-1.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/clusteredheatmapnospecific-2.png)<!-- -->
...
![](phenotype_frequency_distributions_final_files/figure-gfm/promiscuitydeterminantsRE-1.png)<!-- -->
...
```
    ...
    ## Residuals:
    ##       Min        1Q    Median        3Q       Max 
    ## -0.039828 -0.006944 -0.004730  0.006566  0.028149 
    ## 
    ## Coefficients:
    ##             Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) 0.005608   0.002738   2.048  0.04835 *  
    ## p12pred     0.347637   0.092586   3.755  0.00065 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 0.01325 on 34 degrees of freedom
    ## Multiple R-squared:  0.2931, Adjusted R-squared:  0.2723 
    ## F-statistic:  14.1 on 1 and 34 DF,  p-value: 0.0006501
    ## 
    ## [1] "AncSR2"
    ## 
    ## Call:
    ...
    ## Residuals:
    ##       Min        1Q    Median        3Q       Max 
    ## -0.066628 -0.006332 -0.004747  0.005672  0.060619 
    ## 
    ## Coefficients:
    ##             Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) 0.007320   0.001607   4.556 1.28e-05 ***
    ## p12pred     0.900036   0.055346  16.262  < 2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error:
    ## 22 AncSR2        TA  0.0073927786 0.077482978 0.6942372 0.28749143
    ## 23 AncSR2        TC -0.0069019532 0.103496916 0.6930472 0.28749143
    ## 24 AncSR2        TG  0.0008483817 0.840996415 0.6862964 0.87603793
    ## 25 AncSR2        TT  0.0100121761 0.015120172 0.7012529 0.09450107
...
![](phenotype_frequency_distributions_final_files/figure-gfm/promiscuitydeterminantsRE-2.png)<!-- -->
...
|:--------------|:--------------|-----:|----------:|
| nonfunctional | promiscuous   | 1012 | 0.4183547 |
| nonfunctional | specific      | 1300 | 0.5374122 |
| promiscuous   | promiscuous   |   14 | 0.0057875 |
| promiscuous   | specific      |    2 | 0.0008268 |
| specific      | nonfunctional |   12 | 0.0049607 |
| specific      | promiscuous   |   60 | 0.0248036 |
| specific      | specific      |   19 | 0.0078545 |
...
![](phenotype_frequency_distributions_final_files/figure-gfm/bgphenotypeswitch-1.png)<!-- -->
...
| AncSR1   | AncSR2        |   n |      frac |
|:---------|:--------------|----:|----------:|
| specific | nonfunctional |  12 | 0.1318681 |
| specific | promiscuous   |  60 | 0.6593407 |
| specific | specific      |  19 | 0.2087912 |
...
![](phenotype_frequency_distributions_final_files/figure-gfm/bgphenotypeswitch-2.png)<!-- -->
...
| AncSR1      | AncSR2        |   n |      frac |
|:------------|:--------------|----:|----------:|
| promiscuous | promiscuous   |  14 | 0.1308411 |
| promiscuous | specific      |   2 | 0.0186916 |
| specific    | nonfunctional |  12 | 0.1121495 |
| specific    | promiscuous   |  60 | 0.5607477 |
| specific    | specific      |  19 | 0.1775701 |
...
![](phenotype_frequency_distributions_final_files/figure-gfm/bgphenotypeswitch-3.png)<!-- -->
...
| AncSR1        | AncSR2      |    n |      frac |
|:--------------|:------------|-----:|----------:|
| nonfunctional | promiscuous | 1012 | 0.4204404 |
| nonfunctional | specific    | 1300 | 0.5400914 |
| promiscuous   | promiscuous |   14 | 0.0058164 |
| promiscuous   | specific    |    2 | 0.0008309 |
| specific      | promiscuous |   60 | 0.0249273 |
| specific      | specific    |   19 | 0.0078936 |
...
![](phenotype_frequency_distributions_final_files/figure-gfm/bgphenotypeswitch-4.png)<!-- -->
...
```
    ...
    ##   <fct>     <lgl>             <int>  <int> <dbl>
    ## 1 ERE (GT)  FALSE                12     49 0.245
    ## 2 SRE1 (AA) FALSE                 0     23 0    
    ## 3 SRE2 (GA) FALSE                 3     15 0.2  
    ## 4 AC        FALSE                 0      2 0    
    ## 5 AT        FALSE                 0     22 0    
    ## 6 CA        FALSE                 0      5 0    
    ## 7 GG        FALSE                 1      4 0.25 
    ## 8 TA        FALSE                 5     11 0.455
    ## 9 TT        FALSE                 1      4 0.25
...
![](phenotype_frequency_distributions_final_files/figure-gfm/bgphenotypeswitch-5.png)<!-- -->
