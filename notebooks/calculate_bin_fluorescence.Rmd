...
First, we create a function to extract normalized GFP fluorescence values from FCS files. GFP fluorescence is recorded in the FITC channel. We assume FSC-A to be proportional to the area of the cross section of a cell. We normalize GFP by cell volume by taking $\textrm{FITC-A} / \textrm{FSC-A}^{1.5}$. The log-10 of this value our measure of fluorescence.
